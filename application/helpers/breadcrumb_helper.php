...
function create_breadcrumb()
{
	...
	elseif($ci->uri->segment(1) == 'reports')
	{
		...
		elseif($ci->uri->segment(2) == 'summary_invoicing')
		{
			$return.=create_report_breadcrumb(lang('reports_invoicing_summary_report'));
		}
		elseif($ci->uri->segment(2) == 'detailed_invoicing')
		{
			$return.=create_report_breadcrumb(lang('reports_detailed_invoicing_report'));
		}

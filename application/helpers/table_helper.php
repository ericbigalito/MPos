...
function get_items_manage_table($items,$controller)
{
	...
	if ($has_cost_price_permission)
	{
		...
		$CI->lang->line('whole_sale_price'),
		//$CI->lang->line('retail_price'),
...
function get_item_data_row($item,$controller)
{
	...
	if($has_cost_price_permission)
	{
		...
		$table_data_row.='<td width="11%" align="right">'.to_currency($item->location_wholesale_price ? $item->location_wholesale_price: $item->wholesale_price, 10).'</td>';
		//$table_data_row.='<td width="11%" align="right">'.to_currency($item->location_retail_price ? $item->location_retail_price: $item->retail_price, 10).'</td>';
	}

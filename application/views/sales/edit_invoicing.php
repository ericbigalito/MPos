<?php $this->load->view("partial/header"); ?>
	...
	<?php echo form_open("sales/save_invoicing/".$sale_info['sale_id'],array('id'=>'sales_edit_form','class'=>'form-horizontal')); ?>
	...
	<div class="form-group">	
		...
		<div class="col-sm-9 col-md-9 col-lg-10 sale-s">
			<?php echo anchor('sales/invoicing/'.$sale_info['sale_id'], $this->config->item('sale_prefix').' '.$sale_info['sale_id'], array('target' => '_blank'));?>
		</div>
	</div>
	...
	{
	?>
	<?php echo form_open("sales/undelete_invoicing/".$sale_info['sale_id'],array('id'=>'sales_undelete_form','class'=>'form-horizontal')); ?>
	...
	echo form_open("sales/change_invoicing/".$sale_info['sale_id'].'/'.'1',array('id'=>'sales_change_form','class'=>'form-horizontal')); ?>
	...
	<?php
		...
		{ 
	 			echo form_open("sales/delete_invoicing/".$sale_info['sale_id'],array('id'=>'sales_delete_form','class'=>'form-horizontal')); ?>

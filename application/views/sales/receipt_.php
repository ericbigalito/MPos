...
<div id="wrapper" <?php echo $this->uri->segment(1)=='sales' || $this->uri->segment(1)=='receivings'  ? 'class="minibar"' : ''; ?> >
	...
	<div id="content"  class="clearfix sales_content_minibar1" style="padding-left: -47px;">
		...
		<div id="receipt_wrapper">
			<?php {?>
			<?php echo img(array('src' => $this->Appconfig->get_top_image(),'width'=>'100%')); ?></div>
		<?php } ?>
		<table width="100%" >
			<tr>
				<td width="50%">
				...
				<td width="50%" align="center">
					...
					<div id="employee"><?php echo lang('employees_served').": ".$employee; ?></div>
				</td>
			</tr>
		</table>
		...
		{
			?>
			<div id="customer"><?php echo "<b>". lang('customers_customer').":</b> ".$customer; ?></div>
			<?php if(!empty($customer_address_1)){ ?><div><?php echo "</b>". lang('common_address'); "</b>" ?> : <?php echo $customer_address_1. ' '.$customer_address_2; ?></div><?php } ?>
			...
			<?php if(!empty($customer_phone)){ ?><div><?php echo "<b>". lang('common_phone_number'); "</b>" ?> : <?php echo $customer_phone; ?></div><?php } ?>
			<?php if(!empty($customer_email)){ ?><div><?php echo "<b>". lang('common_email'); "</b>" ?> : <?php echo $customer_email; ?></div><?php } ?>
			<?php
		}
		?>
	...
	<table id="receipt_items" border="1px solid blue">
		<tr>
	...
	<div class="hidden-print" id="section-to-print">
		<div id="receipt_header">
			<div id="company_name"><?php echo $this->config->item('company'); ?></div>
		...
		<table id="receipt_items" border="1px solid blue">
			<tr>
				<th style="width:<?php echo $discount_exists ? "33%" : "49%"; ?>;text-align:center;"><?php echo lang('sales_items_del'); ?></th>
				<th style="width:20%;text-align:center;"><?php echo lang('sales_items_prie'); ?></th>
				<th style="width:15%;text-align:center;"><?php echo lang('sales_quantity'); ?></th>
				<?php if($discount_exists)
				{
					?>
		...
		<div id="signature">
			<?php echo lang('sales_issued'); ?>	  ----------------------------------------------
			<?php echo lang('sales_sign'); ?> ------------------------ <br /><br />
			<?php echo lang('sales_approved'); ?> ----------------------------------------------
			<?php echo lang('sales_sign'); ?> ------------------------ <br />
			<?php ?>
	...
	<div style="padding-left: 10%">
		<button class="btn btn-primary text-white hidden-print" id="print_button" onclick="print_delivery()" > <?php echo lang('sales_print_delivery'); ?> </button>
	</div>
	<style type="text/css">
		/*@media print{
            body *{
            ...
            #section-to-print, #section-to-prin{
                visibility: visible;
            }
            #section-to-print{
                position: absolute;
...
<script type="text/javascript">
	function print_delivery()
	{
		...
		//$("div").removeClass("hidden-print");
		//$('#receipt_wrapper').addClass('hidden-print');
		//$('#section-to-print').removeClass('hidden-print');
		...
		$("#section-to-print, #section-to-print *").css({
			"visibility": "visible"
		});
		...
		/*$('#section-to-print').click(function()
		 {
		 $("div").removeClass("hidden-print");
		 $("@media print").css(
		 {

...
<div class="clear"></div>
	...
	<div class="container-fluid">
		...
		<div class="form-group">
		<?php echo form_label(lang('items_item_number').':', 'name',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label  ','style'=>'display:none')); ?>
			<div class="col-sm-9 col-md-9 col-lg-10" style="display: none;">
			<?php echo form_input(array(
				'class'=>'form-control form-inps',
		...
		<div class="form-group">
			<?php echo form_label(lang('items_product_id').':', 'product_id',array('class'=>'col-sm-3 col-md-3 col-lg-2 control-label wide','style'=>'display:none')); ?>
			<div class="col-sm-9 col-md-9 col-lg-10" style="display: none;">
				<?php echo form_input(array(
					'name'=>'product_id',
					'id'=>'product_id',

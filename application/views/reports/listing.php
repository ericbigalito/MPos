	...
	<div class="col-md-6" id="report_selection">
		<div class="panel">
			...
			<h3 class="page-header text-info">&laquo; <?php echo lang('reports_make_a_selection')?></h3>
				...
				<div class="list-group invoice hidden">
					<a class="list-group-item" href="<?php echo site_url('reports/summary_invoicing');?>" ><i class="fa fa-building-o"></i> <?php echo lang('reports_summary_reports'); ?></a>
					<a class="list-group-item" href="<?php echo site_url('reports/detailed_invoicing');?>" ><i class="fa fa-calendar"></i> <?php echo lang('reports_detailed_reports'); ?></a>
				</div>

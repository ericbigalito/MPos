	...
	<div class="row ">
		...
		if (!is_on_demo_host()) { ?>
			<div class="col-md-12" style="text-align: right;">
				<strong><a href="http://tracecoreafrica.com/buy_additional.php" target="_blank"><?php echo lang('locations_adding_location_requires_addtional_license'); ?></a></strong>
			</div>
		 <?php } ?>
...
<?php if (!is_on_demo_host()) { ?>
	...
	$('#new_location_btn').click(function()
	{
		...
		{
			window.location='http://tracecoreafrica.com/buy_additional.php';
			return false;
		}
	})
	</script>	

...
<?php if (isset($needs_auth) && $needs_auth) {?>
	...
	<h3 style="margin-left: 80px;"><a href="http://tracecoreafrica.com/buy_additional.php" target="_blank"><?php echo lang('locations_purchase_additional_licenses'); ?> &raquo;</a></h3>

...
class Item extends CI_Model
{
	...
	*/
	...
	/*
	 * return cost price*/
	function get_cost_price($item_id){
	...
	/*
	 * return whole sale price*/
	function get_wholesale_price($item_id){
	...
	/*
	 * return retail price*/
	function get_retail_price($item_id){
	...
	*/
	function get_all($limit=10000, $offset=0,$col='item_id',$order='desc')
	{
		...
		location_items.wholesale_price as location_wholesale_price,
